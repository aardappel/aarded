...
public class AardappelRuntime {
  ...
  public static void rterror(String s) { msg("fatal: "+s); System.exit(1); }
  public static void msg(String s) { System.out.println("aardappelruntime: "+s); }
  ...
  public static void interntab(int i) { rterror("table: "+i); }
  public static void debugarg(Rval a) { if(self.dbg!=null) self.dbg.arg(a); }
  public static void debugtree(int id) { if(self.dbg!=null) self.dbg.tree(id); }

  public static Rint rint(int i) { return new Rint(i); }
  public static Rreal rreal(double r) { return new Rreal(r); }

  public Rval runcode(int codeid, Rval freevars[]) { rterror("runcode"); return null; }
  public void run(String[] servers, byte[] classdata) { rterror("run"); }
  public Rval runrule() { rterror("runrule"); return null; }
  ...
  public void connectserver(String servername, byte[] classdata) {
    ...
    try {
      ...
      msg("host "+servername+" won't participate: error connecting or rmi registry could not be contacted:\n"+e);
    }
  };
  ...
  public static void newthread(Rbag parent, int codeid, Rval freevars[]) {
    if(self.server!=null) {
      ...
      try {
        ...
        msg("could not launch thread on remote host "
  ...
  public synchronized static Rval plot(Rval x, Rval y, Rval r, Rval g, Rval b) {
    if(self.gfxc==null) return null;
    if(x.id!=idint || y.id!=idint || r.id!=idint || g.id!=idint || b.id!=idint) return null;
    try {
  ...
  public synchronized static Rval builtin_rule_flatten_1(Rval x) throws RemoteException {
