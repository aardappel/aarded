...
class Compiler extends Codegen {
  ...
  int getlocnum() { return ++curloc; }
  int getbagtnum() { return curbagt++; }
  ...
  Vector addrules(Rules r, String name, int localnum, String localspec) {
    ...
    for(int a = 0;a<v.size();a+=2) {
      ...
      if(narg>AardappelRuntime.maxchildren) throw new CompError("current max number of children exceeded for "+idn);
  ...
  String makeident(String s) {
    ...
    for(int a = 0;a<s.length();a++) {
      char c = s.charAt(a);
      t+=((c>='a' && c<='z') || (c>='A' && c<='Z') || c=='_' || (c>='0' && c<='9'))?""+c:(""+((int)c));
    }
    return t;
  };
  ...
  Sym findsym(String id, int narg) { return (Sym)syms.get(id+"_"+narg); }
...
class AardEdDebug extends Debug {
  ...
  Vector syms;
  Vector v = new Vector();
  public void arg(Rval a) { v.addElement(a); };
  ...
  public static Debug getdbg() { return dbg; };
}
...
class CodeAccess implements Access {
  ...
  CodeAccess(Vector v, int o) { syms =v; offs = o; }
  ...
  public Object rv(Rval a) { return new Atom(n(a)); }
  public Object rv(Rint a) { return new Int(a.v); }
  public Object rv(Rreal a) { return new Real(a.v); }
  ...
  public Object rv(Rtree2 a) { return ((Tree)rv((Rtree1)a)).add(code(a.c2)); }
  public Object rv(Rtree3 a) { return ((Tree)rv((Rtree2)a)).add(code(a.c3)); }
  public Object rv(Rtree4 a) { return ((Tree)rv((Rtree3)a)).add(code(a.c4)); }
  public Object rv(Rtree5 a) { return ((Tree)rv((Rtree4)a)).add(code(a.c5)); }
  public Object rv(Rtree6 a) { return ((Tree)rv((Rtree5)a)).add(code(a.c6)); }
  public Object rv(Rtree7 a) { return ((Tree)rv((Rtree6)a)).add(code(a.c7)); }
  public Object rv(Rtree8 a) { return ((Tree)rv((Rtree7)a)).add(code(a.c8)); }
  public Object rv(Rtree9 a) { return ((Tree)rv((Rtree8)a)).add(code(a.c9)); }
  public Object rv(Rtree10 a) { return ((Tree)rv((Rtree9)a)).add(code(a.c10)); }
  public Object rv(Rtree11 a) { return ((Tree)rv((Rtree10)a)).add(code(a.c11)); }
  public Object rv(Rtree12 a) { return ((Tree)rv((Rtree11)a)).add(code(a.c12)); }
}
